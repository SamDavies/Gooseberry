...
const SiteHead = props => {
    const title = !props.title ? 'Gooseberry' : `${props.title} - Gooseberry`
    return <Head>
        ...
        <meta key='og-site-name' property='og:site_name' content='Gooseberry' />
        <meta key='og-type' property='og:type' content='website' />
        ...
        <meta key='twitter-site' name='twitter:site' content='Gooseberry' />
...
SiteHead.defaultProps = {
    ...
    description: 'GradeHub component library.'
}
